...
import PaymentModal from './../ModalBox/PaymentModal';
const BannarPremium = () => {
  return (
    <div className="min-h-[320px] text-white w-full mb-10">
       <div className="premium_bannar_bg py-7 px-10 w-full">
